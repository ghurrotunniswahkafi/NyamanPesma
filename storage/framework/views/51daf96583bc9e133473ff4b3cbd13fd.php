...
<body>
    <nav>
        ...
        <ul>
            ...
            <li>
                <a href="<?php echo e(url('facility/asrama')); ?>">Facility</a>
            </li>
            <li>
                <a href="#">News</a>
            </li>
...
<section class="more">
  ...
  <div class="layanan">
    ...
    <a href="#">Selengkapnya →</a>
        ...
        <div class="information">
            <a href="<?php echo e(url('facility/asrama')); ?>"><i class="fa-solid fa-couch"></i></a>
            <h3>Facility</h3>
            <a href="<?php echo e(url('facility/asrama')); ?>">For More →</a>
        </div>
        <div class="information">
...
</html><?php /**PATH C:\xampp\htdocs\pesma\resources\views/home.blade.php ENDPATH**/ ?>