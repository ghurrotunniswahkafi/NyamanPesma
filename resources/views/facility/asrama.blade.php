        ...
        <section class="asrama-putra-section">
            <div class="section-content">
                <div class="asrama-putra-details">
                    ...
                    <p class="description">Each room accommodates 3 students<br>Only {{ $asramaPutra->jumlah_asrama }} rooms left</p>
                    <div class="buttons">
            ...
            <div class="pop-up-asrama-putra" id="pop-up-asrama-putra">
                <div class="pop-up-asrama-putra-content">
                    ...
                    <div class="pop-up-asrama-putra-details">
                        <p>{{ $asramaPutra->jumlah_asrama }} rooms remaining for {{ $asramaPutra->total_kapasitas }} people left.</p>
                        <p>Harga Bulanan: Rp {{ number_format($asramaPutra->harga_bulanan, 0, ',', '.') }}</p>
                        <p>Harga Tahunan: Rp {{ number_format($asramaPutra->harga_tahunan, 0, ',', '.') }}</p>
                        <strong>Fasilitas:</strong>
                        <ul>
                            @foreach ($asramaPutra->fasilitas as $f)
                            <li>{{ $f }}</li>
                            @endforeach
                        </ul>
                    </div>
        ...
        <section class="asrama-putri-section">
            <div class="section-content">
                ...
                <div class="asrama-putri-details">
                    ...
                    <p class="description">Each room accommodates 3 students<br>Only {{ $asramaPutri->jumlah_asrama }} rooms left</p>
                    <div class="buttons">
            ...
            <div class="pop-up-asrama-putri" id="pop-up-asrama-putri">
                <div class="pop-up-asrama-putri-content">
                    ...
                    <div class="pop-up-asrama-putri-details">
                        <p>{{ $asramaPutri->jumlah_asrama }} rooms remaining for {{ $asramaPutri->total_kapasitas }} people left.</p>
                        <p>Harga Bulanan: Rp {{ number_format($asramaPutri->harga_bulanan, 0, ',', '.') }}</p>
                        <p>Harga Tahunan: Rp {{ number_format($asramaPutri->harga_tahunan, 0, ',', '.') }}</p>
                        <strong>Fasilitas:</strong>
                        <ul>
                            @foreach ($asramaPutri->fasilitas as $f)
                            <li>{{ $f }}</li>
                            @endforeach
                        </ul>
                    </div>
